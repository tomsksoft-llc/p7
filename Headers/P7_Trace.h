...
//
// macOS note:
// This function uses semaphore with name in the following format:
//    "/LAUS_<pid>_Trc_<i_pName>",
// and semaphore name on macOS is limited to SEM_NAME_LEN=30 (without null-terminator)
// So considering <pid> max length = 7 chars,
// i_pName length should be <= 12 chars, otherwise this function will fail
