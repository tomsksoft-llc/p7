...
//#include <semaphore.h>
#include "PSemaphore.h"  // use stubs for semaphore functions

//#include <time.h>
#include "PClock.h" // stubs for clock_gettime
...
public:
    ...
    tBOOL Clr(tUINT32 i_dwID)
    {
        ...
        if (m_pEvents[i_dwID].iCounter)
        {
            ...
            _sem_trywait(&m_sSem); //decrease semaphore
    ...
    tUINT32 Get_Signal()
    {
        ...
        do
        {
            ...
            if (m_pEvent_Cur->iCounter)
            {
                ...
                {
                    _sem_post(&m_sSem); //return sem value to signal again
                }
                else
                {
